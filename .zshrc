...
POWERLINE_RIGHT_A="%D{%H:%M:%S} %D{%Y-%m-%d} %(?.%F{cyan}✔ %?.%F{red}✘ %?)"
...
plugins=(git history history-substring-search brew terraform zsh-completions zsh-syntax-highlighting zsh-autosuggestions lein)
